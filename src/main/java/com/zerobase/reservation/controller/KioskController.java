...
public class KioskController {
    ...
    public String addKiosk(@RequestHeader String token,@PathVariable Long shop_id ){ //키오스크 추가
    ...
    public String checkReservation(@PathVariable Long kiosk_id, @RequestBody KioskInputForm form){
